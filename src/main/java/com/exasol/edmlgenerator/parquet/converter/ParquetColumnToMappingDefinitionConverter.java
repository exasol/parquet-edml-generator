...
import static com.exasol.edmlgenerator.parquet.converter.ColumnSizeCalculator.*;
import static com.exasol.edmlgenerator.parquet.converter.UnsupportedTypeExceptionBuilder.createUnsupportedTypeException;
 ...
 */
public class ParquetColumnToMappingDefinitionConverter {
     ...
     */
    public MappingDefinition convert(final Type column) {
    ...
    private static class NonLogicalTypeConvertVisitor implements TypeVisitor {
        ...
        private MappingDefinition buildMappingForPrimitiveType(final PrimitiveType primitiveType) {
            ...
            default:
                throw createUnsupportedTypeException(primitiveTypeName + "-primitive-type",
