...
/**
 * This class converts parquet logical types to edml definitions. See:
...
class LogicalTypeConverter {
     ...
     */
    public MappingDefinition convert(final LogicalTypeAnnotation logicalType, final String columnName) {
